...
"use strict";
    +function(a, b) {
    var c= {
    name: "TheSaaS", version:"1.4.2"}
;
    c.defaults= {
    googleApiKey: null, googleAnalyticsId:null, smoothScroll:!0;
}
, c.breakpoint= {
...
, 300): c.trigger("click");
    ...
    var b=a(this), d= {
    imageSrc: b.data("parallax"), speed:.3, bleed:50;
}
;
    ...
    var b= {
    lat: "", lng:"", zoom:13, markerLat:"", markerLng:"", markerIcon:"", style:""}
;
...
, zoom:Number(b.zoom);
    ...
    position:  {
    lat: Number(b.markerLat), lng:Number(b.markerLng);
}
, map:d, animation:google.maps.Animation.DROP, icon:b.markerIcon;
...
,  {
    ...
    break;
    default: Array.isArray(b.style)&&d.set("styles", b.style);
}
});
}, c.carousel=function() {
    a(".swiper-container").each(function() {
    var b= {
    autoplay: 3e3, speed:1e3, loop:!0, breakpoints: {
    480:  {
    slidesPerView: 1;
}
}}, d=a(this);
...
, offset: "100%"});
    ...
    AOS.init( {
    offset: 220, duration:1500, disable:"mobile"}
);
}, c.topbar=function() {
    var c=a("body");
    a(b).on("scroll", function() {
    ...
    var b=a(this), c=b.next(".nav-submenu"), d=b.closest(".nav-submenu");
    ...
    var b=a(this), d=b.data("type").split(", "), e= {
    strings: d, typeSpeed:50, backDelay:800, loop:!0;
}
;
    ...
    var b=a("#contact-name").val(), c=a("#contact-email").val(), d=a("#contact-message").val(), e="name="+b+"&email="+c+"&message="+d, f=/^(([^<>()\[\]\\., ;
    : \s@"]+(\.[^<>()\[\]\\., ;
    :\s@"]+)*)|(".+"))@((\[[0-9] {
    1, 3;
}
...
\.[0-9] {
    ...
    type: "POST", url:"assets/php/sendmail_depricated.php", data:e, success:function() {
...
\.[0-9] {
    ...
    type: "POST", url:c.attr("action"), data:c.serializeArray();
}
).done(function(b) {
    var d=a.parseJSON(b);
